<div class="page-header">
    <h2 class="text-uppercase">Collapse</h2>
</div>

<div class="space"></div>
<span id="collapse" class="nID"></span>
<div class="panel panel-default">
    <div class="panel-heading">
        <h3 class="panel-title md-title">Accordions</h3>
    </div>
</div>
        ...
        <pre class="brush: html">
            <div class="panel-group" id="accordion">
                <div class="panel panel-default">
                    <a data-toggle="collapse" data-parent="#accordion" href="#c9">
                        <div class="panel-heading">
                            <h4 class="panel-title"><i class="fa fa-plane"></i>...</h4>
                        </div>
                    </a>
                    <div id="c9" class="panel-collapse collapse in">
                        <div class="panel-body">
                ...
                <div class="panel panel-default">
                    <a data-toggle="collapse" data-parent="#accordion" href="#c1a">
                        <div class="panel-heading">
                            <h4 class="panel-title"><i class="fa fa-desktop"></i>...</h4>
                        </div>
                    </a>
                    <div id="c1a" class="panel-collapse collapse">
                        <div class="panel-body">
