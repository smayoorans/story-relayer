...
<fmt:bundle basename="message">
    <head>
        <title>
            <fmt:message key="welcome.to.story.relayer"/>
        </title>
    </head>
        ...
        <div class="bg-filter sTop">
            <div class="container" style="margin-top: -80px;">
                <div class="jumbotron trn v-center">
                    <h1 class="wow fadeInUp" data-wow-delay="0.1s"><fmt:message key="welcome.to.story.relayer"/></h1>
                    ...
                    <ul class="list-inline wow fadeInUp" data-wow-delay="0.3s">
                        <security:authorize access="isAuthenticated()">
                            <li>
                                <a href="#get-started" class="btn btn-default-trn btn-xlg scroll">
                                    <i class="fa fa-bolt"></i> <fmt:message key="initiate.story"/>
                                </a>
                            </li>
                        </security:authorize>
                        <li>
                            <a href="#top-rated-stories" class="btn btn-primary btn-xlg scroll">
                                <i class="fa fa-paper-plane-o"></i> <fmt:message key="browser.stories"/>
                            </a>
                        </li>
                    </ul>
                </div>
    ...
    <section class="section">
        <div class="container">
            <h2 class="lg-title lg-title-border"><fmt:message key="top.rated.stories"/>
                <a href="top-rated" class=" pull-right btn btn-primary scroll">
                    <fmt:message key="browse.more"/> <i class="fa fa-angle-double-right"></i>
                </a>
            </h2>
            ...
            <div class="row">
                ...
                <c:forEach var="story" items="${topRatedStoryList}" varStatus="status" begin="0" end="5" step="1">
                    ...
                    <div class="col-md-3 col-lg-3 col-sm-6 wow fadeInLeft" data-wow-delay="0.8s">
                        <div class="news">
                            <img class="img-responsive" src="resources/HTML/assets/img/768w/oliver_twist.jpg"
                                 alt="camera">
                            ...
                            <br>
                            <em><fmt:message key="category.label"/> :<c:out value="${story.genre}"/></em>
                            <p>${story.summary}</p>
